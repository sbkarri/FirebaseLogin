...
class LoginActivityTest6 {
    ...
    fun loginActivityTest6() {
        ...
        appCompatEditText.perform(replaceText("ye"), closeSoftKeyboard())

        val appCompatEditText2 = onView(
            allOf(
                withId(R.id.username), withText("ye"),
                childAtPosition(
                    allOf(
                        withId(R.id.container),
                        childAtPosition(
        ...
        appCompatEditText15.perform(replaceText("test@Gmail.c"))

        val appCompatEditText16 = onView(
            allOf(
                withId(R.id.username), withText("test@Gmail.c"),
                childAtPosition(
                    allOf(
                        withId(R.id.container),
                        childAtPosition(
        ...
        appCompatEditText18.perform(replaceText("123455678"), closeSoftKeyboard())
